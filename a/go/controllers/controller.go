...
import (
	...
	a_orm "github.com/thomaspeugeot/testprobe/a/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*a_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*a_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *a_orm.BackRepoStruct, stackPath string) {
