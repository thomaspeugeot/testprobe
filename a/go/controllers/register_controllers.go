...
func registerControllers(r *gin.Engine) {
	v1 := r.Group("/api/github.com/thomaspeugeot/testprobe/a/go")
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	// log.Println("Stack github.com/thomaspeugeot/testprobe/a/go, onWebSocketRequestForBackRepoContent")
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/thomaspeugeot/testprobe/a/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/thomaspeugeot/testprobe/a/go:\n",
		...
		parts := strings.Split("github.com/thomaspeugeot/testprobe/a/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
...
func (controller *Controller) GetLastCommitFromBackNb(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) GetLastPushFromFrontNb(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "GET Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
