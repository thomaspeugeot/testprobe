...
func (controller *Controller) PostA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) UpdateA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) DeleteA(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/thomaspeugeot/testprobe/a/go, Unkown stack: \"" + stackPath + "\"\n"
