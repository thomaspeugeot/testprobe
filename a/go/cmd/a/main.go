...
import (
	...
	a_models "github.com/thomaspeugeot/testprobe/a/go/models"
	a_stack "github.com/thomaspeugeot/testprobe/a/go/stack"
...
func main() {
	...
	stack := a_stack.NewStack(r, "a", *unmarshallFromCode, *marshallOnCommit, "", *embeddedDiagrams, true)
	stack.Probe.Refresh()
	...
	stager := a_models.NewStager(r, stack.Stage, splitStage)
