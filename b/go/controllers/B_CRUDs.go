...
func (controller *Controller) PostB(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "Post Stack github.com/thomaspeugeot/testprobe/b/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) UpdateB(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "PATCH Stack github.com/thomaspeugeot/testprobe/b/go, Unkown stack: \"" + stackPath + "\"\n"
...
func (controller *Controller) DeleteB(c *gin.Context) {
	...
	backRepo := controller.Map_BackRepos[stackPath]
	if backRepo == nil {
		message := "DELETE Stack github.com/thomaspeugeot/testprobe/b/go, Unkown stack: \"" + stackPath + "\"\n"
