...
import (
	...
	b_orm "github.com/thomaspeugeot/testprobe/b/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*b_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*b_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *b_orm.BackRepoStruct, stackPath string) {
